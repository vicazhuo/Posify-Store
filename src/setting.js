...
const VUE_APP_API_URL = process.env.VUE_APP_API_URL || `http://p1.shuqiaodb.cc/storeapi`;
// 管理端ws
const VUE_APP_WS_ADMIN_URL = process.env.VUE_APP_WS_ADMIN_URL || `ws://p1.shuqiaodb.cc/ws`

<template>
	<div>
					...
					<Col span="24">
						<Col v-bind="grid">
							<FormItem label="门店简介："label-for="introduction">
								<Input v-model="formItem.introduction" maxlength="100" show-word-limit placeholder="请输入门店简介"  class="inputW" />
							</FormItem>
						</Col>
					</Col>
					<Col span="24">
		...
		<Modal v-model="modalPic" width="950px" scrollable  footer-hide closable title='上传门店照片' :mask-closable="false" :z-index="99">

...
export function cashierDetail(id, uid) {
	return request({
		url: `order/cashier/detail/${id}/${uid}`,
		method: 'get'
	});
}
...
export function cashierCartList(uid,staff_id,data) {
	return request({
		url: `order/cashier/cart/${uid}/${staff_id}`,
		method: 'get',
		params: data
	});
}
...
export function cashierCouponList(uid,data) {
    return request({
        url: `order/cashier/coupon_list/${uid}`,
        method: 'post',
				data
    });
}
...
export function postCashierSwitch(data,staffId) {
    return request({
        url: `order/cashier/switch/${staffId}`,
        method: 'post',
				data
    });
}
...
export function getHangList(id,data) {
    return request({
        url: `order/cashier/hang/list/${id}`,
        method: 'get',
				params: data
    });
}
